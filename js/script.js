...
var showConditionOrNot = 0;
var showTheCondition = function(){
    $('#conditionLink').click(function(){
        //$(this).after("<div>hello</div>");
        if(!showConditionOrNot)
        {
            $(this).after("<div class='signConditionContent' id='conditionContent'>我是條款內容</div>");
            showConditionOrNot = 1;
        }
        else
        {
            showConditionOrNot = 0;
...
var showCalendarDetail = function(){
    $('.myPagediv table .selected').mouseenter(function(e){
        sx = e.pageX + document.documentElement.scrollTop;
        sy = e.pageY + document.documentElement.scrollLeft;
        $('body').append("<table class='calendarDetail'></table>");
        $('.calendarDetail').css("left", sx)
                            .css("top", sy);
       
        for (var i = 8; i < 19; i++) {
            $('.calendarDetail').append("<tr><td class='time'>"+i+":00</td><td class='act'></td></tr>");
        };
        for (var i = 19; i < 23; i++) {
            $('.calendarDetail').append("<tr><td class='time'>"+i+":00</td><td class='actSelected'><a href='project3.html'>創新應用研討會</a></td></tr>");
        };
    });
    
    $('.myPagediv table .selected').mouseleave(function(e){
        mx = e.pageX + document.documentElement.scrollTop;
        my = e.pageY + document.documentElement.scrollLeft;
        if(mx >= sx && my >= sy)
        {
            $('.calendarDetail').mouseleave(function(){
                $('.calendarDetail').remove(); 
            });
        }
        else
        {
